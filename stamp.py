...
for f in pathlib.Path(".").glob("*.html"):
    ...
    f.write_text(t)
print(f"stamped CSS v={cssv}  JS v={jsv}  HERO v={herov}  PP v={ppv}  PRICE v={xpricev}")
